...
6. **Build the tactical layer** — Feature matrix, GTM comparison, customer signals with evidence tiers
7. **Cascade every insight to "So What"** — Observation → Implication → Response → Confidence → Watch indicator
...
- Produces artifacts a PM cannot produce unaided — this is the knowledge weapon test
