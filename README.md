...
### [Competitive & Market Analysis](skills/competitive-market-analysis/SKILL.md)
...
### [Metric Design & Experimentation](skills/metric-design-experimentation/SKILL.md)
...
### [Specification Writing](skills/specification-writing/SKILL.md)
...
### [Problem Framing](skills/problem-framing/SKILL.md)
...
### [Discovery & Research](skills/discovery-research/SKILL.md)
...
### [Narrative Building](skills/narrative-building/SKILL.md)
...
- **[Figma vs Canva vs Adobe Express](docs/use-case-figma-canva-express.md)** — Who wins the design tools war and why Canva's enterprise play changes the answer
- **[M365 Copilot Adoption](docs/use-case-metric-design.md)** — How to measure whether a $30/user AI copilot is actually delivering value
- **[AI Chat Interface Spec](docs/use-case-specification.md)** — A spec for a ChatGPT-style interface complete enough that an engineer starts building without questions
- **[Notion's Growth Plateau](docs/use-case-problem-framing.md)** — Why Notion's growth stalled and which of 12 root causes actually matter
- **[Superhuman vs Gmail](docs/use-case-discovery-research.md)** — What users say they want from email vs what their behavior reveals
- **[Cursor's Positioning](docs/use-case-narrative-building.md)** — How Cursor positioned itself against GitHub Copilot and VS Code in a market Microsoft owns

**Multi-skill case studies:**
- **[Art Gallery Expansion](docs/case-study-art-gallery.md)** — A solopreneur decides whether to open a second location, from problem framing through final spec
- **[Meditation App Engagement](docs/case-study-meditation-app.md)** — A growth PM diagnoses why 30-day retention is falling, across 5 skills end-to-end
