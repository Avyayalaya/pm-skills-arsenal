---
layout: default
title: "Competitive Analysis: Figma vs Canva vs Adobe Express"
parent: Use Cases
nav_order: 1
---
...
- [x] Competitive set defined: primary (Figma, Canva, Adobe Express) + secondary (Sketch, Penpot, Microsoft Designer) + non-obvious (AI-native design tools)
...
**License:** MIT
**PM Skills Arsenal:** [competitive-market-analysis](https://github.com/Avyayalaya/pm-skills-arsenal/blob/main/skills/competitive-market-analysis/SKILL.md)
...
- See [Narrative Building use case](use-case-narrative-building.html) for positioning strategy based on competitive moats
- See [Specification Writing use case](use-case-specification.html) for translating competitive insights into feature specs
- See [Problem Framing use case](use-case-problem-framing.html) for identifying gaps competitors aren't solving
